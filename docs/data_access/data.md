...
This section describes how to read and write the **endpoint's data**. It also describes how to create a cloud.iO **application**, as it also have to access the **data** as defined here.
To create a **python** cloud.iO **application**, a library exists [here](https://pypi.org/project/cloudio-connector-python/).

## Read last value / data structure

The data structure and last values of each [endpoint data structure](/about_cloudio/data_structure) element can be requested.
